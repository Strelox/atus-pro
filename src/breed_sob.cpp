...
* @brief This program solves the stationary Gross--Pitaevskii equation for a real wave function in 2D or 3D using the sobolev gradient method.
*
...
namespace BreedSolver
{
  ...
  */
  ...
  void MySolver<dim>::run()
  {
    ...
    pcout << "m_final_error of m_Psi: " << m_final_error << endl;
